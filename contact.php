...
<head>
    ...
    <title>Contact || Wayul Tour & Travels</title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            <div class="page-header__top">
                <div class="page-header-bg" style="background-image: url(assets/images/destination/doodhpathri-waterfall.jpg)">
                </div>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="contact-page__left">
                            <div class="section-title text-left">
                                <span class="section-title__tagline">Talk with Us</span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-4">
                        <!--Information Single-->
                        <div class="information__single" style="padding:51px 10px">
                            <div class="information__icon">
                                <span class="icon-place"></span>
                            </div>
                            <div class="information__text">
                                <p>CD Hospital Road Drugjan Dalgate</p>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="information__single">
                            ...
                            <div class="information__text">
                                <h4>
                                    <a href="tel:+92-666-888-0000" class="information__number-1">+91 9622781016</a>
                                    <br>
                                    <a href="tel:666-888-0000" class="information__number-2">+91 9469016009</a>
                                </h4>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="information__text">
                                <h4>
                                    <a href="mailto:wayiltourandtravels@gmail.com"
                                        class="information__mail-1">wayiltourandtravels<br />@gmail.com</a>
                                    <!-- <a href="mailto:info@tevily.com" class="information__mail-2"></a> -->
                                </h4>
                            </div>
                        </div>
                    </div>
        ...
        <section class="contact-page-google-map">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d559.9787681655974!2d74.83032493451725!3d34.077991634124224!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1759046876333!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade""
