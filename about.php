...
<head>
    ...
    <title>About || Wayul Tour & Travels</title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            <div class="page-header__top">
                <div class="page-header-bg" style="background-image: url(assets/images/destination/doodhpathri.jpg)">
                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-page__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Dare to Explore with Wayil Tour & Travels</h2>
                            </div>
                            <p class="about-page__text-1">A Simply Perfect Way to Discover Kashmir</p>
                            <p class="about-page__text-2">
                                We are trusted by travelers and known for providing unforgettable journeys across Kashmir.
                                Wayil Tour & Travels is dedicated to offering the
                                finest experiences, blending comfort, culture, and adventure.
                                With us, every trip becomes a story worth remembering.</p>
                            <div class="about-page__progress">
                                ...
                                <div class="about-page__progress-single">
                                    <h4 class="about-page__progress-title">Happy Customers</h4>
        ...
        <div class="video-two">
            <div class="video-two-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
                style="background-image: url(assets/images/resources/gardens.jpg)"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="video-two__inner">
                            ...
                            <h2 class="video-one__title">Wayil Tour & Travels is Best <br> and Reliable.
                            </h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="counter-one__container">
                <ul class="list-unstyled counters-one__box">
                    <li class="counter-one__single wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <p class="counter-one__text">Total Tours</p>
                    </li>
...
<!-- Mirrored from tevily-html.vercel.app/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Sep 2025 14:02:08 GMT -->
