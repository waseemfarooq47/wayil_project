                          ...
                          <div class="footer-widget__column footer-widget__about">
                              <div class="footer-widget__about-logo">
                                  <a href="index.php"><img
                                          src="assets/images/resources/changed-logo.png"
                                          alt="" style="width:280px;height:80px" /></a>
                              </div>
                              <p class="footer-widget__about-text">
                                  <b>Welcome to Wayil Tour & Travels</b>
                                  Discover the beauty of Kashmir with our trusted trip and tour services.
                              </p>
                              <ul class="footer-widget__about-contact list-unstyled">
                                  <li>
                                      ...
                                      <div class="text">
                                          <a href="tel:+91 96227 81016">+91 96227 81016 | +91 9469016009</a>
                                      </div>
                                  </li>
                                  <li>
                                      <div class="icon">
                                      ...
                                      <div class="text">
                                          <a href="Wayiltourandtravels@gmail.com">wayiltourandtravels@gmail.com</a>
                                      </div>
                                  </li>
                                  <li>
                                      <div class="icon">
                                      ...
                                      <div class="text">
                                          <p>CD Hospital Road Drugjan Dalgate, Srinagar Kashmir - 190001</p>
                                      </div>
                                  </li>
                              </ul>
                          </div>
                      ...
                      <div
                          ...
                          <div class="footer-widget__column footer-widget__explore">
                              ...
                              <ul class="list-unstyled footer-widget__explore-list">
                                  <li><a href="pahalgam.php">Pahalgam</a></li>
                                  <li><a href="gulmarg.php">Gulmarg</a></li>
                                  <li><a href="sonmarg.php">Sonmarg</a></li>
                                  <li><a href="gurez.php">Gurez</a></li>
                                  <li><a href="leh-ladakh.php">Leh & Ladakh</a></li>
                              </ul>
                          </div>
                      </div>
                      <div
                  ...
                  <div class="col-xl-12">
                      <div class="site-footer__bottom-inner">
                          ...
                          <div class="site-footer__bottom-right">
                              <p>@ All Copyright 2025, <a href="#">Wayil Tour & Travels</a></p>
                          </div>
                          <div class="site-footer__bottom-left-arrow">
                              <a
                                  href="#"
                                  data-target="html"
                                  class="scroll-to-target scroll-to-top"><span class="icon-right-arrow"></span></a>
                          </div>
                      </div>
                  </div>
              </div>
