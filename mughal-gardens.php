    ...
    <section class="page-header">
      <div class="page-header__top">
        <div
          ...
          style="
              background-image: url(assets/images/resources/gardens.jpg);
            "></div>
        <div class="page-header-bg-overly"></div>
        <div class="container">
          <div class="page-header__top-inner">
            <h2>Mughal gardens - The Grandeur of Mughal Architecture</h2>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="page-header__bottom-inner">
            <ul class="thm-breadcrumb list-unstyled">
              ...
              <li><span>.</span></li>
              <li class="active">Mughal-gardens</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="col-xl-8 col-lg-7">
            <div class="destinations-details__left">
              <div class="destinations-details__img">
                <img
                  src="assets/images/destination/mgarden.jpg"
                  alt="" />
              </div>
              <div class="destinations-details__discover">
                <h3 class="destinations-details__title">Discover Mughal Gardens of Kashmir</h3>
                ...
                <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                  <div class="accrodion active">
                    <div class="accrodion-title">
                      <h4>Why visit the Mughal Gardens in Kashmir?</h4>
                    </div>
                  ...
                  <div class="accrodion">
                    <div class="accrodion-title">
                      <h4>What are the main Mughal Gardens to visit?</h4>
                    </div>
                    <div class="accrodion-content">
                      <div class="inner">
                        <p>
                          <strong>Shalimar Bagh</strong> – Known as the ‘Abode of Love,’ with terraced lawns and fountains.
                          <strong>Nishat Bagh</strong> – The ‘Garden of Joy,’ famous for its layout and Dal Lake views.
                          <strong>Chashme Shahi</strong> – A small but charming garden with natural springs.
                          <strong>Pari Mahal</strong> – The ‘Palace of Fairies,’ perched on Zabarwan Hills overlooking Dal Lake.
                        </p>
                      </div>
                      <!-- /.inner -->
                    </div>
                  ...
                  <div class="accrodion last-chiled">
                    <div class="accrodion-title">
                      <h4>What activities can tourists enjoy at the Mughal Gardens?</h4>
                    </div>
                    <div class="accrodion-content">
                      <div class="inner">
                        <p>
                ...
                <ul class="tour-details-two__last-minute-list list-unstyled">
                  <li>
                    <div class="tour-details-two__last-minute-image">
                      <img
                        src="assets/images/destination/shalimar.jpeg"
                        alt=""
                        class="thumb-size" />
                    </div>
                    <div class="tour-details-two__last-minute-content">
                      ...
                      <p>Terraced gardens with fountains, originally built for royal leisure.</p>
                    </div>
                  </li>
                  <li>
                    <div class="tour-details-two__last-minute-image">
                  ...
                  <li>
                    <div class="tour-details-two__last-minute-image">
                      <img
                        src="assets/images/destination/chasmashahi.jpg"
                        alt=""
                        class="thumb-size" />
                    </div>
                    <div class="tour-details-two__last-minute-content">
            ...
            <div class="container">
              ...
              <div class="row masonary-layout">
                <div class="col-xl-3 col-lg-3">
                  <div class="destinations-one__single">
                    <div class="destinations-one__img">
                      <img src="assets/images/destination/parmahal.jpg" alt="">
                      <div class="destinations-one__content">
                        <p class="destinations-one__sub-title">Fairy Palace</p>

                        <h2 class="destinations-one__title"><a href="destinations-details.html">Parimahal Garden</a></h2>
                      </div>
                ...
                <div class="col-xl-6 col-lg-6">
                  <div class="destinations-one__single">
                    <div class="destinations-one__img">
                      <img src="assets/images/destination/shalimar.jpeg" alt="">
                      <div class="destinations-one__content">
                        <p class="destinations-one__sub-title">Blooming Nature</p>
                        <h2 class="destinations-one__title"><a href="destinations-details.html">Shalimar Garden</a></h2>
                      </div>
                      <div class="destinations-one__button">
                        <a href="#">Shalimar</a>
                      </div>
                ...
                <div class="col-xl-3 col-lg-3">
                  <div class="destinations-one__single">
                    <div class="destinations-one__img">
                      <img src="assets/images/destination/chasmashahi.jpg" alt="">
                      <div class="destinations-one__content">
                        <p class="destinations-one__sub-title">Fountains</p>
                        <h2 class="destinations-one__title"><a href="destinations-details.html"> Chesmashahi garden</a></h2>
                      </div>
                      <div class="destinations-one__button">
                        <a href="#">Chesmashshi</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6">
                  <div class="destinations-one__single">
                    <div class="destinations-one__img">
                      <img src="assets/images/destination/nishat.jpg" alt="">
                      <div class="destinations-one__content">
                        <p class="destinations-one__sub-title">Beauty</p>
                        <h2 class="destinations-one__title"><a href="destinations-details.html">Nishat Garden</a></h2>
                      </div>
                      <div class="destinations-one__button">
                        <a href="#">Nishat</a>
                      </div>
                ...
                <div class="col-xl-6 col-lg-6">
                  <div class="destinations-one__single">
                    <div class="destinations-one__img">
                      <img src="assets/images/resources/gardens.jpg" alt="">
                      <div class="destinations-one__content">
                        <p class="destinations-one__sub-title">Tulip Flowers</p>
                        <h2 class="destinations-one__title"><a href="destinations-details.html">Tulip Garden</a></h2>
                      </div>
                      <div class="destinations-one__button">
                        <a href="#">Tulip</a>
                      </div>
